  ...
  return (
    <div className="deleteLauris-container">
      <div className="deleteLauris-wrapper">
        ...
        {deleteLauris ? (
          <div className="deleteLauris-image-wrapper">
            <img
              className="deleteLauris-image"
              src="https://images.unsplash.com/photo-1580128637456-8f5ee699d117?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=787&q=80"
              alt="lauris picture"
            ></img>
          </div>
        ) : null}
